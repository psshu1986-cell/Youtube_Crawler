...
// ../.wrangler/tmp/bundle-SQDGXk/checked-fetch.js
...
__name(isoDurationToSeconds, "isoDurationToSeconds");
...
async function onRequest(context) {
  ...
  try {
    let buildRecords = function(rows) {
      const records = [];
      const now = Date.now();
      for (const r of rows) {
        ...
        const daysSince = Math.max((now - published) / 864e5, 0.01);
        records.push({
          videoId: r.videoId,
          title: r.title,
    ...
    __name(buildRecords, "buildRecords");
    ...
    const since = new Date(Date.now() - risingDays * 864e5).toISOString();
    seen.clear();
    const risingResults = [];
    for (const kw of keywords) {
    ...
    for (const r of risingResults) {
      ...
      if (!s) continue;
      const published = new Date(r.publishedAt).getTime();
      const daysSince = Math.max((Date.now() - published) / 864e5, 0.01);
      topRising.push({
        videoId: r.videoId,
        title: r.title,
        channelTitle: r.channelTitle,
...
// ../.wrangler/tmp/pages-isTP9B/functionsRoutes-0.6322758504716276.mjs
var routes = [
  {
...
// C:/Users/ShuD_PC/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/ShuD_PC/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// C:/Users/ShuD_PC/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/ShuD_PC/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-SQDGXk/middleware-insertion-facade.js
...
// C:/Users/ShuD_PC/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-SQDGXk/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7406763362650398.mjs.map
