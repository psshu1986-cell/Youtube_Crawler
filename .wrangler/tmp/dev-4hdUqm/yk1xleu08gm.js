...
// .wrangler/tmp/bundle-9Tfg0T/checked-fetch.js
...
// .wrangler/tmp/pages-isTP9B/functionsWorker-0.7406763362650398.mjs
...
__name2(isoDurationToSeconds, "isoDurationToSeconds");
...
__name2(searchKeyword, "searchKeyword");
...
async function onRequest(context) {
  ...
  try {
    let buildRecords = /* @__PURE__ */ __name(function(rows) {
      const records = [];
      const now = Date.now();
      for (const r of rows) {
    ...
    __name2(buildRecords, "buildRecords");
...
// C:/Users/ShuD_PC/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-dev-util.ts
...
// .wrangler/tmp/pages-isTP9B/yk1xleu08gm.js
...
// .wrangler/tmp/bundle-9Tfg0T/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-9Tfg0T/middleware-loader.entry.ts
